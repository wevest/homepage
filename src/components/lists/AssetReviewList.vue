        ...
        <q-list separator class="rounded-borders">
            ...
            >
                ...
                <q-item-section top>
                    <q-item-label>
                        <div class="row">
                            <div class="displayName q-px-sm q-py-xs" :style="v_rating_color(a_review)">
                                <span class="gUserNameSM text-white"> {{a_review.user.display_name}}</span>
                                <q-icon class="q-ml-xs text-white vertical-top" style="font-size: 1.4em;" name="arrow_circle_up" />
