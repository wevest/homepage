...
export default {
    ...
    methods: {
        setPageParameter: function(response) {
            logger.log.debug("CommentList.setPageParameter:response=",response);
        ...
        onClickVoteComment: function(dicParam) {
            ...
            logger.log.debug("CommentList.onClickVoteComment=",dicParam);
        ...
        onClickSaveComment: function(dicParam) {
            ...
            logger.log.debug("CommentList.onClickSaveComment : dicParam=",dicParam);
            ...
            dicParam.post.comment(dic_param).then(response=>{
                logger.log.debug("CommentList.onClickSaveComment - response",_this.g_data);                
                dicParam.post.addCommentFirst(response.data.data);
                dicParam.editor.clear();
                CommonFunc.showOkMessage(_this,"Comments Posted");

            }).catch(err=>{
                logger.log.error("CommentList.onClickSaveComment - error",err);
